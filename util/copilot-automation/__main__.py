...
def build_json_prompt(issue_number, issue_id):
    ...
    return json.dumps({
        "content": (
            ...
            "The TOML content should NOT contain any properties other than `name`, `url`, `favicon`, and `updated`. `updated` should be the current ISO-8601 date WITH timezone. If other properties are present, the results will be considered incorrect. "
